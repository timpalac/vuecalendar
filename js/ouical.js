;(function(exports) {
  ...
  var generateMarkup = function(calendars, clazz, calendarId) {
    ...
    result.innerHTML = '<label for="checkbox-for-' +
      calendarId + '" class="add-to-calendar-checkbox btn btn-light">Save to <span>Your</span> Calendar</label>';
    result.innerHTML += '<input name="add-to-calendar-checkbox" class="add-to-calendar-checkbox" id="checkbox-for-' + calendarId + '" type="checkbox">';

    var icons = document.createElement('div');
    icons.innerHTML += '<h4>Add to Your Calendar</h4>';
    Object.keys(calendars).forEach(function(services) {
      icons.innerHTML += calendars[services];
    });
    icons.className = 'add-to-calendar-icons';
